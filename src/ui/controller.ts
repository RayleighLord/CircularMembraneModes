...
export type ControllerAction =
  ...
  | { readonly type: "set-mode-index"; readonly axis: "m"; readonly value: ModeSelection["m"] }
  | { readonly type: "set-mode-index"; readonly axis: "n"; readonly value: ModeSelection["n"] }
...
function withMode(
  ...
  if (validated.m === state.mode.m && validated.n === state.mode.n) {
    return state;
  }
